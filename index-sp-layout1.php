...
<!-- Mirrored from kodesolution.com/html/2016/echarity-html/demo/index-sp-layout1.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 30 Oct 2023 04:47:19 GMT -->
<head>
...
<div id="wrapper">
  ...
  <div class="main-content">
    ...
    <!-- Section: Causes 3 -->
    <section class="bg-lighter" id="causes"> 
   ...
   <!-- Section: Running Project 1  -->
    ...
    <section class="divider parallax" id="donation" data-bg-img="images/bg/bg2.jpg" data-parallax-ratio="0.7">
      <div class="container pt-0 pb-0">
        <div class="row">
          <div class="col-md-8">
      ...
      <div class="container">
        <div class="row pt-30">
          ...
          <div class="col-md-8">
            ...
            <!-- Contact Form -->
            <form id="contact_form" name="contact_form" class="" action="https://kodesolution.com/html/2016/echarity-html/demo/includes/sendmail.php" method="post">
